...
This Python script extracts item information from Vendor quote PDFs, specifically:
...
1. Place all your Vendor quote PDFs in the folder:
   `C:\Users\<your-username>\Documents\Quotes\<Vendor Name>`
...
2. Check that the PDF format matches the Vendor template
